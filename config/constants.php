<?php
	return [
        ...
        'additional-services'=>['check'=>['tariff_classification_check'=>'TARIFF CLASSIFICATION', 'foreign_custom_check'=>'FOREIGN CUSTOMS','local_customs_check'=>'LOCAL CUSTOMS','ica_certificate_check'=>'ICA CERTIFICATE','totalize_pl_check'=>'TOTALIZE PL','autograde_check'=>'ORIGIN AUTOGRADE CERTIFICATION','dian_approval_check'=>'DIAN APPROVAL','invima_approval_check'=>'INVIMA APPROVAL','dta_otm_check'=>'DTA/OTM','insurance_check'=>'INSURANCE','plant_health_check'=>'PLANT HEALTH CERTIFICATE','collect_freight_check'=>'COLLECT FREIGHT','shipping_pl_check'=>'SHIPPING PL','pl_development_check'=>'PL DEVELOPMENT'],
