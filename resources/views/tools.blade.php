						...
						<div class="panel-body">
							<div class="col-md-12 tool">
								...
								<div id="accordion_tool">
				                    <h3>{{ trans('messages.How to calculate the cargo volume') }}</h3>
									<div class="box-body ">
										<div class="col-md-12 col-sm-12 estimated">
											<div class="tools-cube"><h4>
												<p>{{ trans('messages.Simply be sure to have the measurement for lenght and width of the base of the item as well as its height. The volume will be the result of multiplying these three measurements') }}</p>
											</h4>
											<table>
												<tr>
											...
											<p>{{ trans('messages.If you want the capacity in cubic meters, you must express each measurement in meters so the result is expressed in CBMs') }}</p></DIV>
									...
									<div class="box-body ">
										<div class="col-md-12 col-sm-12 estimated">
											...
											<p></p>
											<h4>{{ trans('messages.*DIMENSIONS AND CAPACITIES MAY VARY ACCORDING TO THE CONTAINER MANUFACTURER') }}</h4>
									...
									<div class="box-body ">
										<div class="col-md-12 col-sm-12 estimated3">
											...
											<h4>{{ trans('messages.AGENTE DE ADUANA *SOCIEDAD DE INTERMEDIACION ADUANERA (SIA)') }}</h4>
									...
									<div class="box-body ">
										<div class="col-md-12 col-sm-12 estimated4">
                                          ...
                                          <p>{{trans('messages.Damage to goods occured without the intervention of human elements.') }}</p>
                                           ...
                                           <h4>{{ trans('messages.AIRFREIGHT DEMURRAGE') }}</h4>
                                           ...
                                           <p>{{trans('messages.When used in foreign trade, a commercial invoice is a customs document. It is used as a customs declaration provided by the person or corporation that is exporting an item across international borders.') }}</p>
                                           ...
                                           <p>{{trans('messages.International Air Transportation Association, supports aviation with global standards for airline safety, security, efficiency and sustainability.') }}</p>
                                            <h4>{{ trans('messages.CARGO MANIFEST') }}</h4>
