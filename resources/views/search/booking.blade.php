                ...
                <div id="accordion">
                    ...
                    <div class="col-md-8 transport">
                      <table class="col-md-12 table-bordered table-striped table-condensed cf">
                        <tbody>
                          ...
                          <?php }?>
                          <tr>
                            <td class="tabel-info">ENT {{ trans('messages.TRANSIT_TIME') }}</td>
                  ...
                  <div class="box-body ">
                    <div class="col-md-12 conditions">
                      ...
                      <span> <input type="checkbox" name="agree" value="check">  {{ trans('messages.I_agree all terms and conditions') }}.</span>
                    </div>
                    <div class="box-footer box-footers">
