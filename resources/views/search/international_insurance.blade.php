...
<?php $search = json_decode($data['searches']->routes);
  ...
  $insurance_fee_per = round($invoice * $data['data']->insurance_fee_percentage, 2);
            ...
            <div class="col-md-12 addition">
              ...
              <form class="form-horizontal" role="form" method="POST" action="{{ newurl('/quote/international_insurance') }}">
				   ...
				   <div class="cargobackground clearfix">
                    ...
                    <fieldset class="col-sm-9 cargoborder">
					    <div class="input-group">
							...
							<input type="text" class='insurance_fee_percentage invoice-input' value="<?php echo $data['data']->insurance_fee_percentage;?>" disabled="disabled">
							<div class="input-group-addon">
								<i class="fa fa-percent"></i>
							</div>
                ...
                <div class="form-group{{ $errors->has('cargo_cifs') ? ' has-error' : '' }}">
                  <div class="col-md-12">
				   <div class="cargobackground clearfix">
                    <label class="col-sm-3">CIF {{ trans('messages.CARGO_VALUE') }}</label>
                    <fieldset class="col-sm-9 cargoborder">
					   <div class="input-group">
							<div class="input-group-addon">
								<i class="fa fa-dollar"></i>
							</div>
							<input type="text" class="cargo_cif invoice-input" value="<?php echo numberFormat($invoice+$insurance_fee); ?>" disabled="disabled" class="invoice-input">
					  ...
					  <div class="cargobackground clearfix">
					    ...
					    <fieldset class="col-sm-9 cargoborder">
						  <div class="input-group">
							...
							<input type="text" id="customs_percentage" class="customs invoice-input"  value="<?php echo $customs_per;?>" disabled="true">
							<div class="input-group-addon">
								<i class="fa fa-percent"></i>
							</div>
                 ...
                 <div class="col-md-12">
                  ...
                  <fieldset class="col-sm-9 cargoborder">				  
				     <div class="input-group">
						...
						<input type="text" id="vat_percentage" class="invoice-input" value="<?php echo $data['data']->vat_percentage;?>" disabled="true">
						<div class="input-group-addon">
							<i class="fa fa-percent"></i>
						</div>
			  ...
			  <div class="form-group">
			   ...
			   <div class="form-group">
                <div class="col-md-12">
				 <div class="cargobackground clearfix">
                    <label class="col-sm-3">TOTAL {{ trans('messages.CARGO_VALUE') }} %</label>
                  <fieldset class="col-sm-9 cargoborder">
				    <div class="input-group">
						<div class="input-group-addon">
							<i class="fa fa-dollar"></i>
						</div>
						 <input type="text" name="cargo_totals" value="<?php echo numberFormat($data['searches']->quote_fee); ?>" class="invoice-input"/>
					 </div>
				  </fieldset>
                 </div>
				</div>
