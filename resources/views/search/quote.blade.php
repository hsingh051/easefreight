                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td><?php echo $value->container_number;?></td>
                              <td><?php echo '$'.$custom->customs_brokerage_documentation->charge;?></td>
                              <td><?php echo $data['ff']->name;?></td>
                            </tr>
                          <?php } ?>
                          <tr>
                  ...
                  <div class="box-body ">
                    ...
                    <?php } if(isset($foreign->general->docs_rad->charge) && @$foreign->general->docs_rad->charge){ ?>
                      <div class="col-md-12 additionalrate">
                        <div class="form-group has-feedback">
                          ...
                          <div class="col-sm-3">
                            <?php if(isset($foreign->general->docs_rad->charge)){ echo $foreign->general->docs_rad->charge;}?>
                          </div>  
                          <div class="security-align">
                            <label class="col-sm-3 control-label" for="" style="text-align: right">{{ trans('messages.Note') }}:</label>
                          </div>
                    ...
                    <?php } if(isset($foreign->general->caf->charge) && @$foreign->general->caf->charge){ ?>
                      <div class="col-md-12 additionalrate">
                        <div class="form-group has-feedback">
                          ...
                          <div class="col-sm-3">
                            <?php if(isset($foreign->general->caf->charge)){ echo $foreign->general->caf->charge;}?>
                          </div>  
                          <div class="security-align">
                            <label class="col-sm-3 control-label" for="" style="text-align: right">{{ trans('messages.Note') }}:</label>
                          </div>
                    ...
                    <?php } if(isset($foreign->general->release->charge) && @$foreign->general->release->charge){ ?>
                      <div class="col-md-12 additionalrate">
                        <div class="form-group has-feedback">
                          ...
                          <div class="col-sm-3">
                            <?php if(isset($foreign->general->release->charge)){ echo $foreign->general->release->charge;}?>
                          </div>  
                          <div class="security-align">
                            <label class="col-sm-3 control-label" for="" style="text-align: right">{{ trans('messages.Note') }}:</label>
                          </div>
                    ...
                    <?php } if(isset($foreign->general->anti_narcotics->charge) && @$foreign->general->anti_narcotics->charge){ ?>
                      <div class="col-md-12 additionalrate">
                        <div class="form-group has-feedback">
                          ...
                          <div class="col-sm-3">
                            <?php if(isset($foreign->general->anti_narcotics->charge)){ echo $foreign->general->anti_narcotics->charge;}?>
                          </div>  
                          <div class="security-align">
                            <label class="col-sm-3 control-label" for="" style="text-align: right">{{ trans('messages.Note') }}:</label>
                          </div>
                    ...
                    <?php } if(isset($foreign->general->dian_inspection->charge) && @$foreign->general->dian_inspection->charge){ ?>
                      <div class="col-md-12 additionalrate">
                        <div class="form-group has-feedback">
                          ...
                          <div class="col-sm-3">
                            <?php if(isset($foreign->general->dian_inspection->charge)){ echo $foreign->general->dian_inspection->charge;}?>
                          </div>  
                          <div class="security-align">
                            <label class="col-sm-3 control-label" for="" style="text-align: right">{{ trans('messages.Note') }}:</label>
                          </div>
                    ...
                    <?php } if(isset($foreign->general->extra_weight_surcharge->charge) && @$foreign->general->extra_weight_surcharge->charge){ ?>
                      <div class="col-md-12 additionalrate">
                        <div class="form-group has-feedback">
                          ...
                          <div class="col-sm-3">
                            <?php if(isset($foreign->general->extra_weight_surcharge->charge)){ echo $foreign->general->extra_weight_surcharge->charge;}?>
                          </div>  
                          <div class="security-align">
                            <label class="col-sm-3 control-label" for="" style="text-align: right">{{ trans('messages.Note') }}:</label>
                          </div>
                    ...
                    <div class="col-md-12 additionalrate">
                      <div class="form-group has-feedback">
                        ...
                        <div class="col-sm-3">
                          <?php if(isset($foreign->general->extra_length_surcharge->charge)){ echo $foreign->general->extra_length_surcharge->charge;}?>
                        </div>  
                        <div class="security-align">
                          <label class="col-sm-3 control-label" for="" style="text-align: right">{{ trans('messages.Note') }}:</label>
                        </div>
                    ...
                    <div class="col-md-12 additionalrate">
                      <div class="form-group has-feedback">
                        ...
                        <div class="col-sm-3">
                          <?php if(isset($foreign->general->dangerous_cargo_surcharge->charge)){ echo $foreign->general->dangerous_cargo_surcharge->charge;}?>
                        </div>  
                        <div class="security-align">
                          <label class="col-sm-3 control-label" for="" style="text-align: right">{{ trans('messages.Note') }}:</label>
                        </div>
                    ...
                    <?php } if(isset($foreign->general->courrier_charge->charge) && @$foreign->general->courrier_charge->charge){ ?>
                      <div class="col-md-12 additionalrate">
                        <div class="form-group has-feedback">
                          ...
                          <div class="col-sm-3">
                            <?php if(isset($foreign->general->courrier_charge->charge)){ echo $foreign->general->courrier_charge->charge;}?>
                          </div>  
                          <div class="security-align">
                            <label class="col-sm-3 control-label" for="" style="text-align: right">{{ trans('messages.Note') }}:</label>
                          </div>
                    ...
                    <?php } if(isset($foreign->general->freight_certification->charge) && @$foreign->general->freight_certification->charge){ ?>
                      <div class="col-md-12 additionalrate">
                        <div class="form-group has-feedback">
                          ...
                          <div class="col-sm-3">
                            <?php if(isset($foreign->general->freight_certification->charge)){ echo $foreign->general->freight_certification->charge;}?>
                          </div>  
                          <div class="security-align">
                            <label class="col-sm-3 control-label" for="" style="text-align: right">{{ trans('messages.Note') }}:</label>
                          </div>
                    ...
                    <?php } if(isset($foreign->general->dest_BL_emission->charge) && @$foreign->general->dest_BL_emission->charge){ ?>
                      <div class="col-md-12 additionalrate">
                        <div class="form-group has-feedback">
                          ...
                          <div class="col-sm-3">
                            <?php if(isset($foreign->general->dest_BL_emission->charge)){ echo $foreign->general->dest_BL_emission->charge;}?>
                          </div>  
                          <div class="security-align">
                            <label class="col-sm-3 control-label" for="" style="text-align: right">{{ trans('messages.Note') }}:</label>
                          </div>
                    ...
                    <div class="col-md-12 additionalrate">
                      <div class="form-group has-feedback">
                        ...
                        <div class="col-sm-3">
                          <?php if(isset($foreign->general->dest_BL_charge->charge)){ echo $foreign->general->dest_BL_charge->charge;}?>
                        </div>  
                        <div class="security-align">
                          <label class="col-sm-3 control-label" for="" style="text-align: right">{{ trans('messages.Note') }}:</label>
                        </div>
                      ...
                      <?php if(isset($foreign->ofr->dest_charge_flat_rate->charge) && @$foreign->ofr->dest_charge_flat_rate->charge){ ?>
                        <div class="col-md-12 additionalrate">
                          <div class="form-group has-feedback">
                            ...
                            <div class="col-sm-3">
                              <?php if(isset($foreign->ofr->dest_charge_flat_rate->charge)){ echo $foreign->ofr->dest_charge_flat_rate->charge;}?>
                            </div>  
                            <div class="security-align">
                              <label class="col-sm-3 control-label" for="" style="text-align: right">{{ trans('messages.Note') }}:</label>
                            </div>
                      ...
                      <?php } if(isset($foreign->ofr->densite_surcharge->charge) && @$foreign->ofr->densite_surcharge->charge){ ?>
                        <div class="col-md-12 additionalrate">
                          <div class="form-group has-feedback">
                            ...
                            <div class="col-sm-3">
                              <?php if(isset($foreign->ofr->densite_surcharge->charge)){ echo $foreign->ofr->densite_surcharge->charge;}?>
                            </div>  
                            <div class="security-align">
                              <label class="col-sm-3 control-label" for="" style="text-align: right">{{ trans('messages.Note') }}:</label>
                            </div>
                    ...
                    <?php } endif; if($data['containers']->load_type == "fcl"): ?>
                      ...
                      <?php if(isset($foreign->ofr->deposite->charge) && $foreign->ofr->deposite->charge){ ?>
                        <div class="col-md-12 additionalrate">
                          <div class="form-group has-feedback">
                            ...
                            <div class="col-sm-3">
                              <?php if(isset($foreign->ofr->deposite->charge)){ echo $foreign->ofr->deposite->charge;}?>
                            </div>  
                            <div class="security-align">
                              <label class="col-sm-3 control-label" for="" style="text-align: right">{{ trans('messages.Note') }}:</label>
                            </div>
                      ...
                      <?php } if(isset($foreign->ofr->drope_off->charge) && @$foreign->ofr->drope_off->charge){ ?>
                        <div class="col-md-12 additionalrate">
                          <div class="form-group has-feedback">
                            ...
                            <div class="col-sm-3">
                              <?php if(isset($foreign->ofr->drope_off->charge)){ echo $foreign->ofr->drope_off->charge;}?>
                            </div>  
                            <div class="security-align">
                              <label class="col-sm-3 control-label" for="" style="text-align: right">{{ trans('messages.Note') }}:</label>
                            </div>
                      ...
                      <div class="col-md-12 additionalrate">
                        <div class="form-group has-feedback">
                          ...
                          <div class="col-sm-3">
                            <?php if(isset($foreign->ofr->container_loan_contract->charge)){ echo $foreign->ofr->container_loan_contract->charge;}?>
                          </div>  
                          <div class="security-align">
                            <label class="col-sm-3 control-label" for="" style="text-align: right">{{ trans('messages.Note') }}:</label>
                          </div>
