              ...
              <div id="accordion">
                ...
                <div class="box-body ">
                  <div class="col-md-12 transport">
                    <?php $pending_amount = $advance = $grand_total="12222";//$grand_total = round(currency($data['quote']->grand_total,'USD','COP'), 2);
                    ...
                    <table class="col-md-12 table-bordered table-striped table-condensed cf payment-table">
                      <tbody>
                          ...
                          <tr>
                            <td class="tabel-info">{{ trans('messages.advance_document') }}</td>
                          ...
                          <tr>
                            <td class="tabel-info">{{ trans('messages.Booking_Document') }}</td>
