              ...
              <!--   <div class="form-group">
                ...
                <div class="form-group"> 
                  <div class="col-md-7 col-xs-12">
                    <label class="col-md-8 col-xs-11 col-sm-5 control-label textfont formleft">{{ trans('messages.Exporting_Importing Dangerous Goods') }}?</label> <input type="checkbox" name="dangerous_good" value="1" class="col-md-1 col-xs-1 col-xs-1"/>
                  </div>
                </div>
                <div class="divmain">
