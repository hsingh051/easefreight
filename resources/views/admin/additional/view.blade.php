                ...
                <div class="accordion">
                      ...
                      <div class="add-other-fields-js">
                        <div class="col-md-12 additionalrate additionalrating">
                          <div class="form-group has-feedback">
                            ...
                            <div class="security-align">
                              <label class="col-sm-2 control-label" for="">{{ trans('messages.insert_Note') }}:</label>
                            </div>
                            <div class="col-sm-3">
                              <input type="text" value="<?php if(isset($additional->other[$key]->note)){ echo $additional->other[$key]->note;}?>" name="additional[other][<?php echo $key;?>][note]" class="form-control" placeholder="Insert Notes">
                      ...
                      <div class="form-group has-feedback">
                        ...
                        <div class="col-sm-3">
                          <div class="input-group">
								<div class="input-group-addon">
									<i class="fa fa-dollar"></i>
								</div><input type="text" value="<?php if(isset($foreign->general->release->charge)){ echo $foreign->general->release->charge;}?>" name="foreign_charges_content[general][release][charge]" class="form-control" placeholder="$$$"></div>
                        </div>  
                        <div class="security-align">
                          <label class="col-sm-3 control-label" for="">{{ trans('messages.insert_Note') }}:</label>
                        </div>
                      ...
                      <div class="form-group has-feedback">
                        ...
                        <div class="col-sm-3">
                          <div class="input-group">
          								<div class="input-group-addon">
          									<i class="fa fa-dollar"></i>
          								</div><input type="text" value="<?php if(isset($foreign->general->dian_inspection->charge)){ echo $foreign->general->dian_inspection->charge;}?>" name="foreign_charges_content[general][dian_inspection][charge]" class="form-control" placeholder="$$$"></div>
                        </div>  
                        <div class="security-align">
                          <label class="col-sm-3 control-label" for="">{{ trans('messages.insert_Note') }}:</label>
                        </div>
                      ...
                      <div class="form-group has-feedback">
                        ...
                        <div class="col-sm-3">
                          <div class="input-group">
          								<div class="input-group-addon">
          									<i class="fa fa-dollar"></i>
          								</div><input type="text" value="<?php if(isset($foreign->general->extra_weight_surcharge->charge)){ echo $foreign->general->extra_weight_surcharge->charge;}?>" name="foreign_charges_content[general][extra_weight_surcharge][charge]" class="form-control" placeholder="$$$"></div>
                        </div>  
                        <div class="security-align">
                          <label class="col-sm-3 control-label" for="">{{ trans('messages.insert_Note') }}:</label>
                        </div>
                      ...
                      <div class="form-group has-feedback">
                        ...
                        <div class="col-sm-3">
                          <div class="input-group">
            								<div class="input-group-addon">
            									<i class="fa fa-dollar"></i>
            								</div><input type="text" value="<?php if(isset($foreign->general->extra_length_surcharge->charge)){ echo $foreign->general->extra_length_surcharge->charge;}?>" name="foreign_charges_content[general][extra_length_surcharge][charge]" class="form-control" placeholder="$$$"></div>
                        </div>  
                        <div class="security-align">
                          <label class="col-sm-3 control-label" for="">{{ trans('messages.insert_Note') }}:</label>
                        </div>
                      ...
                      <div class="form-group has-feedback">
                        ...
                        <div class="col-sm-3">
                          <div class="input-group">
            								<div class="input-group-addon">
            									<i class="fa fa-dollar"></i>
            								</div><input type="text" value="<?php if(isset($foreign->general->dangerous_cargo_surcharge->charge)){ echo $foreign->general->dangerous_cargo_surcharge->charge;}?>" name="foreign_charges_content[general][dangerous_cargo_surcharge][charge]" class="form-control" placeholder="$$$"></div>
                        </div>  
                        <div class="security-align">
                          <label class="col-sm-3 control-label" for="">{{ trans('messages.insert_Note') }}:</label>
                        </div>
                      ...
                      <div class="form-group has-feedback">
                        ...
                        <div class="col-sm-3">
                          <div class="input-group">
								            <div class="input-group-addon">
            									<i class="fa fa-dollar"></i>
            								</div><input type="text" value="<?php if(isset($foreign->general->freight_certification->charge)){ echo $foreign->general->freight_certification->charge;}?>" name="foreign_charges_content[general][freight_certification][charge]" class="form-control" placeholder="$$$"></div>
                        </div>  
                        <div class="security-align">
                          <label class="col-sm-3 control-label" for="">{{ trans('messages.insert_Note') }}:</label>
                        </div>
                  ...
                  <?php if($insurance_check): ?>
                    ...
                    <div class="box-body ">
                      <div class="col-md-12 additionalrate additionalrating">
                        <div class="form-group has-feedback">
                          <div class="security-align">
                            <label class="col-sm-3 control-label" for="">Commercial Invoice Value:</label>
                          </div>
                          <div class="col-sm-9">
                          	<div class="input-group">
              								<div class="input-group-addon">
                        ...
                        <div class="form-group has-feedback">
                          ...
                          <div class="col-sm-9">
              						   <div class="input-group">
              								...
              								<input type="text" value="" name="insurance[insurance_fee_percentage]" class="form-control has-feedback percentage-fee" placeholder="">
              								<div class="input-group-addon">
              									<i class="fa fa-dollar"></i>
              								</div>
              								<input type="text" value="" name="insurance[insurance_min_fee]" class="form-control has-feedback percentage-fees" placeholder="Minimum Value">
              							</div>
                        ...
                        <div class="form-group has-feedback">
                          ...
                          <div class="col-sm-9">
            						    <div class="input-group">
            								...
            								<input type="text" id="vat_percentage" name="insurance[vat_percentage]" class="invoice-input form-control"/>
            							</div>
                           ...
                           <div class="form-group has-feedback">
            							   ...
            							   <div class="col-sm-9">
            								<div class="input-group">
            									...
            									<input type="text" id="customs_percentage" name="insurance[customs_percentage]" value="" class="form-control">	
                        ...
                        <div class="form-group has-feedback">
                          ...
                          <div class="col-sm-9">
                          	<div class="input-group">
              								...
              								<input type="text" value="" name="insurance[inland]" class="form-control" placeholder="$$$">
              							</div>
                        ...
                        <div class="form-group has-feedback">
                          ...
                          <div class="col-sm-9">
                          	<div class="input-group">
            								...
            								<input type="text" value="" name="insurance[deductible]" class="form-control" placeholder="$$$">
            							</div>
                  ...
                  <div class="box-body ">
                    <div class="form-group has-feedback">
                      <div class="col-md-12 additionalrate additionalrating">
                        <div class="security-align">
                          <label class="col-sm-3 control-label" for="">10 {{ trans('messages.digit_tariff') }} #:</label>
                        </div>
                        <div class="col-sm-3">
                          <input type="text" value="<?php echo $data->cargo_12digit;?>" name="international_custom_content[cargo_12digit]" class="form-control" placeholder="## ## ## ## ##" disabled="disabled">
						            ...
						            <div class="security-align">
                          <label class="col-sm-3 control-label" for="">6 {{ trans('messages.digit_tariff') }} #:</label>
                        </div>
                        <div class="col-sm-3">
