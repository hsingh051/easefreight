              ...
              <?php foreach ($data as $value): ?>
                ...
                <tr>
                  ...
                  <td class="border borders"> <div class="btn-group">
                    <?php $del = newurl('/admin/routeAFR/Delete/'.$value->afr_route_id);
                      $rate = newurl('/admin/tarifasAFR/Add/'.$value->afr_route_id.'/0/0');
                      $itinerary = newurl('/admin/routeItinerary/Add/'.$value->afr_route_id.'/0/0');
                  ...
                  ?>  
                    ...
                    <?php } if(@$value->itinerary_id){
                      $itinerary = newurl('/admin/routeItinerary/Edit'.$value->afr_route_id);
                    ?>  
