            ...
            <div class="form-group has-feedback{{ $errors->has('discontinue_date') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-9">
                <div class="input-group">
                  ...
                  <input type="text" name="discontinue_date" id="discontinue_date" class="form-control  datepicker1" value="<?php echo date('d-m-Y',strtotime($stats['data']->discontinue_date));?>">
                </div>
