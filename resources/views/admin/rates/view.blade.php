                ...
                <?php foreach ($data as $value): ?>
                  ...
                  <tr>
                    ...
                    <td class="border borders"> <div class="btn-group">
                      ...
                      <a class="btn btn-success backbtn" href="<?php echo newurl('/admin/tarifasAFR/Edit/'.$value->afr_route_id.'/'.$value->afr_route_rates_id);?>">
                      ...
                      <?php echo '<a class="btn btn-success backbtn" href="'.URL::to('/').'/admin/tarifasAFR/Delete/'.$value->afr_route_rates_id.'">
