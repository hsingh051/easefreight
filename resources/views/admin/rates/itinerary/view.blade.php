...
<div class="panel-heading routeafr">{{ trans('messages.aereo_Itineraries') }}<a href="{{ newurl('/admin/routeItinerary/Add/0/0/0') }}" class="btn-sm btn-success backbtn"><i class="fa fa-plus"></i>{{ trans('messages.add_aereo_Itineraries') }}</a></div>
