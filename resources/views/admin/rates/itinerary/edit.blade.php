                        ...
                        <div class="form-group has-feedback{{ $errors->has('discontinue_date') ? ' has-error' : '' }}">
                          ...
                          <div class="col-sm-12 col-md-9">
                            <div class="input-group">
                              ...
                              <input type="text" value="<?php if(@$stats['data']->discontinue_date){echo date("d-m-Y",strtotime($stats['data']->discontinue_date));}?>" name="discontinue_date" id="discontinue_date" class="form-control  datepicker1">
                            </div>
