		...
		<div id="accordion">           
            ...
            <div class="box-body">
                ...
                <div class="col-sm-9">
                  <select class="form-control col_change_city turn-to-ac" name="city_id">
                      <?php foreach ($stats['cities'] as $value) {?>
                          <option <?php if($value->city_id == $stats['ocean_local_terminal_rates']->city_id){?> selected="selected" <?php }?> value='<?php echo $value->city_id;?>'><?php echo $value->title;?></option>;
                      <?php 
                      }?>
                  </select>
              ...
              <div class="form-group has-feedback{{ $errors->has('col_city_port_id') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                  <select class="form-control col_city_ports" name="col_city_port_id">
                      <?php foreach ($stats['col_city_ports'] as $value) {?>
                          <option <?php if($value->col_city_port_id == $stats['ocean_local_terminal_rates']->col_city_port_id){?> selected="selected" <?php }?> value='<?php echo $value->col_city_port_id;?>'><?php echo $value->title;?></option>
                      <?php }?>
                  </select>
            ...
            <div class="col-md-12">
                ...
                <div class="form-group has-feedback{{ $errors->has('local_port_charges_20') ? ' has-error' : '' }} col-md-6 col-sm-12 col-xs-12 tarifascol-right">
                 <div class="security-align">
                ...
                <div class="form-group has-feedback{{ $errors->has('local_port_charges_40') ? ' has-error' : '' }} col-md-6 col-sm-12 col-xs-12">
                  <div class="security-align">
                ...
                <div class="form-group has-feedback{{ $errors->has('local_port_charges_40hc') ? ' has-error' : '' }} col-md-6 col-sm-12 col-xs-12 tarifascol-right">
                 <div class="security-align">
            ...
            <div class="form-group has-feedback{{ $errors->has('minimum_value') ? ' has-error' : '' }} col-md-12 col-sm-12 col-xs-12">
              <div class="security-align">
                <label for="minimum_value" class="col-sm-3 col-xs-3 control-label">{{ trans('messages.Minimum_Value') }}</label>
              </div>
