      ...
      <div class="col-md-12">
        ...
        <!-- /.box-header -->
            ...
            <div class="box-body">
              <div class="form-group has-feedback{{ $errors->has('city_id') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9 col-xs-9">
                  <select class="form-control col_change_city turn-to-ac" name="city_id" placeholder="{{ trans('messages.select_city') }}">
              ...
              <div class="form-group has-feedback{{ $errors->has('col_city_port_id') ? ' has-error' : '' }}">
                <div class="security-align">
                  <label for="col_city_port_id" class="col-sm-3 col-xs-3 control-label">{{ trans('messages.City_Port') }}</label>
                </div>
                <div class="col-sm-9 col-xs-9">
          ...
          <div class="form-group has-feedback{{ $errors->has('minimum_value') ? ' has-error' : '' }}">
            <div class="security-align">
              <label for="minimum_value" class="col-sm-3 col-xs-4 control-label">{{ trans('messages.Minimum_Value') }}</label>
            </div>
