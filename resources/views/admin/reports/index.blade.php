    ...
    <section class="content">
      <div class="row Rowaire">
        <div class="col-md-12 col-xs-12 reporting">
          <div class="box">
              <?php if(!isset($data) && !@$data->booking_number): ?>
                <div class="accordion">
                ...
                <form class="form-horizontal" enctype="multipart/form-data" role="form" method="POST" action="{{ newurl('/admin/reports/add') }}">
                  ...
                  <div class="accordion">
                    ...
                    <?php if($reports->include_pickup=="Yes"){?>
                      ...
                      ?>
                      <h3 class="<?php echo $stp1;?>" >{{ trans('messages.CARGO FLOW STEP') }} <?php echo $n;?></h3>
                      <div class="box-body">
                        <div class="form-group has-feedback{{ $errors->has('cargo_pickup_eta_date') ? ' has-error' : '' }}{{ $errors->has('cargo_pickup_eta_time') ? ' has-error' : '' }}">
                          ...
                          <div class="col-sm-9">
                            <div class="input-group col-sm-6 " style="float:left">
                              ...
                              <input name="cargo_pickup_eta_date" value="<?php if(@$data->cargo_pickup_eta_date){ echo date('d-m-Y',strtotime($data->cargo_pickup_eta_date));}?>" class="form-control datepicker " type="text">
                        ...
                        <div class="box-footer box-footers">
                          <div class="left_footer">
                            ...
                            <input name="submit" value="{{ trans('messages.save') }}" class="btn btn-info hideDiv backbtn" type="submit">
                          </div>
                        </div>
                      <?php $n++;?>
                      </div>
                      ...
                      ?>
                      <h3 class="<?php echo $stp2;?>">{{ trans('messages.CARGO FLOW STEP') }} <?php echo $n;?></h3>
                      <div class="box-body">
                        <div class="form-group has-feedback{{ $errors->has('cargo_pickup_ata_date') ? ' has-error' : '' }}{{ $errors->has('cargo_pickup_ata_time') ? ' has-error' : '' }}">
                          ...
                          <div class="col-sm-9">
                            <div class="input-group col-sm-6 " style="float:left">
                              ...
                              <input name="cargo_pickup_ata_date" value="<?php if(@$data->cargo_pickup_ata_date){ echo date('d-m-Y',strtotime($data->cargo_pickup_ata_date));}?>" class="form-control datepicker " type="text">
                        ...
                        <div class="form-group has-feedback{{ $errors->has('port_eta_date') ? ' has-error' : '' }}{{ $errors->has('port_eta_time') ? ' has-error' : '' }}">
                          ...
                          <div class="col-sm-9">
                            <div class="input-group col-sm-6 " style="float:left">
                              ...
                              <input name="port_eta_date" value="<?php if(@$data->port_eta_date){ echo date('d-m-Y',strtotime($data->port_eta_date));}?>" class="form-control datepicker " type="text">
                        ...
                        <div class="box-footer box-footers">
                          <div class="left_footer">
                            <button class="btn btn-info hideDiv next backbtn ml10">{{ trans('messages.next') }}</button>
                            <input type="submit" name="submit" value="{{ trans('messages.save') }}" class="btn btn-info hideDiv backbtn ml10" />
                    ...
                    <?php
                      ...
                      ?>
                    <h3 class="<?php echo $stp3;?>">{{ trans('messages.CARGO FLOW STEP') }} <?php echo $n;?></h3>
                    <div class="box-body">
                      <!-- If Pickup Selected -->
                      <?php if($reports->include_pickup=="Yes"){?>
                        <div class="form-group has-feedback{{ $errors->has('pickup_port_ata_date') ? ' has-error' : '' }}{{ $errors->has('pickup_port_ata_time') ? ' has-error' : '' }}">
                          ...
                          <div class="col-sm-9">
                            <div class="input-group col-sm-6 " style="float:left">
                              ...
                              <input name="pickup_port_ata_date" value="<?php if(@$data->pickup_port_ata_date){ echo date('d-m-Y',strtotime($data->pickup_port_ata_date));}?>" class="form-control datepicker " type="text">
                        ...
                        <div class="form-group has-feedback{{ $errors->has('port_etd_date') ? ' has-error' : '' }}{{ $errors->has('port_etd_time') ? ' has-error' : '' }}">
                          ...
                          <div class="col-sm-9">
                            <div class="input-group col-sm-6 " style="float:left">
                              ...
                              <input name="port_etd_date" value="<?php if(@$data->port_etd_date){ echo date('d-m-Y',strtotime($data->port_etd_date));}?>"class="form-control datepicker " type="text">
                    ...
                    <?php
                      ...
                      ?>
                    <h3 class="<?php echo $stp4;?>">{{ trans('messages.CARGO FLOW STEP') }} <?php echo $n;?></h3>
                    <div class="box-body">
                      <div class="form-group has-feedback{{ $errors->has('port_atd_date') ? ' has-error' : '' }}{{ $errors->has('port_atd_time') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                          <div class="input-group col-sm-6 " style="float:left">
                            ...
                            <input name="port_atd_date" value="<?php if(@$data->port_atd_date){ echo date('d-m-Y',strtotime($data->port_atd_date));}?>" class="form-control datepicker" type="text">
                      ...
                      <div class="form-group has-feedback{{ $errors->has('destination_port_eta_date') ? ' has-error' : '' }}{{ $errors->has('destination_port_eta_time') ? ' has-error' : '' }}">
                          ...
                          <div class="col-sm-9">
                            <div class="input-group col-sm-6 " style="float:left">
                              ...
                              <input name="destination_port_eta_date" value="<?php if(@$data->destination_port_eta_date){ echo date('d-m-Y',strtotime($data->destination_port_eta_date));}?>" class="form-control datepicker " type="text">
                    ...
                    <?php
                      ...
                      ?>
                    <h3 class="<?php echo $stp5;?>">{{ trans('messages.CARGO FLOW STEP') }} <?php echo $n;?></h3>
                    <div class="box-body">
                      <div class="form-group has-feedback{{ $errors->has('destination_port_ata_date') ? ' has-error' : '' }}{{ $errors->has('destination_port_ata_time') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                          <div class="input-group col-sm-6 " style="float:left">
                            ...
                            <input name="destination_port_ata_date" value="<?php if(@$data->destination_port_ata_date){ echo date('d-m-Y',strtotime($data->destination_port_ata_date));}?>" class="form-control datepicker " type="text">
                      ...
                      <div class="form-group has-feedback{{ $errors->has('eta_delivery_date') ? ' has-error' : '' }}{{ $errors->has('eta_delivery_time') ? ' has-error' : '' }}">
                          ...
                          <div class="col-sm-9">
                            <div class="input-group col-sm-6 " style="float:left">
                              ...
                              <input name="eta_delivery_date" value="<?php if(@$data->eta_delivery_date){ echo date('d-m-Y',strtotime($data->eta_delivery_date));}?>" class="form-control datepicker " type="text">
                    ...
                    <?php
                      ...
                      ?>
                    <h3 class="<?php echo $stp6;?>">{{ trans('messages.CARGO FLOW STEP') }} <?php echo $n;?></h3>
                    <div class="box-body">
                      <div class="form-group has-feedback{{ $errors->has('cargo_pickup_delivery_ata_date') ? ' has-error' : '' }}{{ $errors->has('cargo_pickup_delivery_ata_time') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                          <div class="input-group col-sm-6 " style="float:left">
                            ...
                            <input name="cargo_pickup_delivery_ata_date" value="<?php if(@$data->cargo_pickup_delivery_ata_date){ echo date('d-m-Y',strtotime($data->cargo_pickup_delivery_ata_date));}?>" id="" class="form-control datepicker " type="text">
                      ...
                      <div class="form-group has-feedback{{ $errors->has('cargo_delivery_eta_date') ? ' has-error' : '' }}{{ $errors->has('cargo_delivery_eta_time') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                          <div class="input-group col-sm-6 " style="float:left">
                            ...
                            <input name="cargo_delivery_eta_date" value="<?php if(@$data->cargo_delivery_eta_date){ echo date('d-m-Y',strtotime($data->cargo_delivery_eta_date));}?>" class="form-control datepicker " type="text">
                    ...
                    <?php
                      ...
                      ?>
                    <h3 class="<?php echo $stp7;?>">{{ trans('messages.CARGO FLOW STEP') }} <?php echo $n;?></h3>
                    <div class="box-body">
                      <div class="form-group has-feedback{{ $errors->has('cargo_delivery_ata_date') ? ' has-error' : '' }}{{ $errors->has('cargo_delivery_ata_time') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-9">
                          <div class="input-group col-sm-6 " style="float:left">
                            ...
                            <input name="cargo_delivery_ata_date" value="<?php if(@$data->cargo_delivery_ata_date){ echo date('d-m-Y',strtotime($data->cargo_delivery_ata_date));}?>" class="form-control datepicker " type="text">
