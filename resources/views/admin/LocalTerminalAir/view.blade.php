              ...
              ?>
                <tr>
                  ...
                  <td class="border borders"> <div class="btn-group">
                    ...
                    <a class="btn btn-success backbtns" href="<?php echo URL::to('/');?>/admin/localTerminalAir/Edit/<?php echo $value->local_terminal_air_rates_id; ?>"><i class="fa fa-pencil-square-o"    aria-hidden="true"></i></a>
                    <?php echo '<a class="btn btn-success backbtns" href="'.URL::to('/').'/admin/localTerminalAir/Delete/'.$value->local_terminal_air_rates_id.'">
