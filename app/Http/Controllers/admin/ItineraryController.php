...
class ItineraryController extends Controller
{
    ...
    public function viewRouteItinerary() {
        $query =  Itinerary::
                  join('afr_routes', 'itinerary.afr_route_id', '=', 'afr_routes.afr_route_id')
                  ->leftjoin('afr_route_rates as rates', 'rates.afr_route_id', '=', 'afr_routes.afr_route_id')
                  ...
                  ->groupBy('itinerary.afr_route_id');
    ...
    public function getRouteItinerary($route_id=NULL,$id=NULL,$route_result=null) {
    ...
    public function addRouteItinerary(Request $request) {
        ...
        $datas['afr_route_id'] = $post['afr_route_id'];
    ...
    public function geteditRouteItinerary($route_id=NULL,$id=NULL){
    ...
    public function editOFRItinerary(Request $request){
        ...
        if(isset($post['operating_days'])){
            $datas['operating_days'] = "'".implode("','",$post['operating_days'])."'";
        }
        if(isset($post['spot_date'])){
            $datas['spot_date'] = date("Y-m-d",strtotime($post['spot_date']));
        }
        //dd($datas);
