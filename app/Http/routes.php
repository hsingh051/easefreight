...
Route::group(['middleware' => ['web','auth'],'prefix' => 'admin', 'namespace' => 'admin'], function () {
    ...
    Route::get('routeItinerary/Add/{route_id}/{id}/{route_result}', ['uses' => 'ItineraryController@getRouteItinerary','as'   => 'itinerary']);
    ...
    Route::get('routeItinerary/Edit/{route_id}/{id}', ['uses' => 'ItineraryController@geteditRouteItinerary','as'   => 'itinerary']);
    ...
    Route::get('quote/info/{quote_id?}', ['uses' => 'Quote1Controller@getQuoteInfo','as'   => 'quote']);
    Route::post('quote/info', ['uses' => 'Quote1Controller@postQuoteInfo','as'   => 'quote']);

    Route::get('quote/details/{quote_id?}', ['uses' => 'Quote1Controller@getQuote','as'   => 'quote']);
    Route::post('quote/details', ['uses' => 'Quote1Controller@postQuote','as'   => 'quote']);
    Route::post('quote/paymentDocument', ['uses' => 'Quote1Controller@postPaymentDocument','as'   => 'quote']);
